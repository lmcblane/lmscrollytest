    ...
    const storyData = [
      ...
      },
      {
        ...
        chartData: {
            ...
            datasets: [
                { label: 'Europe', data: [50, 67, 76, 87, 92], borderColor: '#22c55e', tension: 0.1, fill: false },
                { label: 'The Americas', data: [36, 49, 65, 80, 88], borderColor: '#3b82f6', tension: 0.1, fill: false },
                { label: 'Asia & Pacific', data: [9, 23, 39, 57, 70], borderColor: '#ef4444', tension: 0.1, fill: false },
                { label: 'Africa', data: [2, 10, 20, 39, 55], borderColor: '#f97316', tension: 0.1, fill: false }
            ]
        },
        steps: [
